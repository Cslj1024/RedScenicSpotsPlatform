<template>
  <div class="login-container">
    ...
    <el-dialog title="Register" :visible.sync="showRegisterDialog">
      ...
      <!-- For example, you can create a separate component for the registration form -->
      <registration-form @registerSuccess="handleRegisterSuccess" />
    </el-dialog>
